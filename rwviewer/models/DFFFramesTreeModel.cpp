...
bool DFFFramesTreeModel::setData(const QModelIndex& index, const QVariant& value,
                                 int role)
{
  if (!index.isValid()) {
    return false;
...
QVariant DFFFramesTreeModel::headerData(int section, Qt::Orientation orientation,
                                        int role) const
{
